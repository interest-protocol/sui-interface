  ...
  const harvest = async () => {
    try {
      ...
      transactionBlock.moveCall({
        ...
        arguments: [
          transactionBlock.object(objects.AMASTER_CHEF_STORAGE),
          transactionBlock.object(objects.AMASTER_CHEF_ACCOUNT_STORAGE),
          transactionBlock.object(objects.AIPX_STORAGE),
