...
import SelectPairToken from './select-pair';

const EarnCreatePool: FC = () => {
  ...
  return (
    <Layout
      dashboard
      titlePage={
        <DetailedHeader description={t('earnCreatePool.metadata.title')} />
      }
    >
          ...
          >
            <Box width={['100%', '100%', '100%', '38rem']}>
              <Box
                ...
                borderRadius="m"
              >
                <SelectPairToken form={form} openModal={openModal} />
