...
const FailModal: FC<EarnCreatePoolModalProps> = ({ handleClose }) => {
      ...
      >
        ...
        >
          ...
          <Typography variant="medium" color="text" textTransform="capitalize">
            {t('common.v2.earnPool.modal.fail.title')}
          </Typography>
        ...
        <Box px="xl" py="s">
          ...
          >
            ...
            >
              {t('common.v2.earnPool.modal.fail.message')}
            </Typography>
          </Box>
