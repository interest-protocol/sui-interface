...
const PreviewTransaction: FC<PreviewTransactionProps> = ({
  ...
  return (
    ...
    >
      <HeaderModal
        title={t('lsd.modal.preview.title')}
      ...
      <Box px="l" pt="l" display="flex" flexDirection="column">
        ...
        >
          ...
          >
            {t('lsd.modal.preview.button', { isStake: +isStake })}
          </Typography>
        </Button>
        <Typography
          variant="extraSmall"
        ...
        >
          <Box display="flex" justifyContent="space-between" width="100%">
            <Typography
              ...
              textTransform="capitalize"
            >
              {t('lsd.modal.preview.depositFee')}
            </Typography>
            <Typography
              variant="extraSmall"
              fontWeight="400"
